...
class CollisionsEngine:
    def is_length_collision(self, object1, object2):
        return object1.left_edge <= object2.right_edge and object2.right_edge >= object1.left_edge

    def is_height_collision(self, object1, object2):
        return object1.top_edge <= object2.bottom_edge and object2.bottom_edge >= object1.top_edge
